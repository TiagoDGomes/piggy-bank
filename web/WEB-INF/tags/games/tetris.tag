...
<script type="text/javascript">
    ...
    function eventFimDeJogo(){
        document.getElementById("statusJogo").innerHTML = "Fim de jogo! Aguarde enquanto seu saldo está sendo atualizado...";
    ...
    function Go() { 
        ...
        if (PosY[0]<0) { 
            ...
            if (IsOver) { 
                ...
                eventFimDeJogo();
                //if (confirm("Valeu, você tem "+Score+" pontos ! Você quer jogar mais de novo ?")) {
                    //Init(true);
                //}
                return;
            }
...
<form name="ScoreForm">
    <div class="jogo tetris" style="" >
        ...
        <div class="placar">
            <img src="tetris/tetrisp0.gif" alt="Previsão" /><br />
            ...
            <span class="lbl">Nível: </span><span id="tetris_nivel">0</span><br />
                ...
                <td valign=top>
                    <table id="tetrisTable" ><tr><td>
                                <table>
                                    ...
                                    <tr><td align="center">Nível:</td></tr>
                                    ...
                                    <tr><td align="center"><input type="checkbox" onclick="IsPreview=this.checked; HideFocus();">Previsão</td></tr>
